            ...
            assert(inst_addr != -1 && next_inst_addr != -1);
            {
                ...
                case Iex_Binop:
                    if (data->Iex.Binop.op == Iop_Add32 || data->Iex.Binop.op == Iop_Add64)
                    {
                        ...
                        {
                            // Do the calculation
                            if (arg1->tag == Iex_RdTmp && tmps[arg1->Iex.RdTmp.tmp].used && arg2->tag == Iex_Const)
                            {
                            ...
                            if (arg1->tag == Iex_Const && arg2->tag == Iex_RdTmp && tmps[arg2->Iex.RdTmp.tmp].used)
                            {
                            ...
                            if (arg1->tag == Iex_RdTmp && tmps[arg1->Iex.RdTmp.tmp].used && arg2->tag == Iex_RdTmp && tmps[arg2->Iex.RdTmp.tmp].used)
                            {
                                ULong arg1_value = tmps[arg1->Iex.RdTmp.tmp].value;
                                ULong arg2_value = tmps[arg2->Iex.RdTmp.tmp].value;
                                ULong value = arg1_value + arg2_value;
